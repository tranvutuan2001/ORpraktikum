#Parameters
NUMBER_OF_YEARS = 25 # also the average lifespan of a heat pump
...
Max_Sales_Growth = 10 # Final value compared to Initial value
...
WORKFORCE_Growth = 2.66  # Final value compared to Initial value
