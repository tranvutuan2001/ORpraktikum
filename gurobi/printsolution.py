...
def write_solution_csv(model, D, M, I, T, distributors, NUMBER_OF_YEARS, MIN_PERCENTAGE,
    ...
    for m, i, d, t in P:
        ...
        if new_installs ==0 and cumulated_amount==0:
            ...
            row = [name, I[i]["district"], I[i]["year of construction"], I[i]["type of building"], I[i]["Heatcapacity"], M[m]['brand_name'], t,new_installs, qty, I[i]["quantity"], percent, I[i]["average heat demand"], distributors[d]['name'], I[i]["zipcode"]]
