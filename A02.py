...
Max_Sales_Growth = 8 # Final value compared to Initial value
Max_Sales_Growth_Center = 20 # value shifts the growth to the left when increased and vise versa, but always greater than -5
Max_Sales_Initial = 110000 # units per year
Max_Sales_Growth_Steepness = 0.5 #linear when set very low, but then the starting and end point are not reached
