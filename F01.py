...
CO2_EMISSION_FACTOR = 0.30
ELECTRICITY_SUBS = 1
HEATPUMP_SUBS = 0.725 # BEG & KfW average funding 2021
CO2_PRIZE_FACTOR = 1.68 # Compared to Initial Value
Max_Sales_Growth = 13 # Final value compared to Initial value
Max_Sales_Growth_Center = 10 # value shifts the growth to the left when increased and vise versa, but always greater than -5
Max_Sales_Initial = 110000 # units per year
Max_Sales_Growth_Steepness = 0.8 #linear when set very low, but then the starting and end point are not reached
WORKFORCE_Growth = 10  # Final value compared to Initial value
Workforce_Growth_Center = 10 # value from 0 to 1 to set the center of growth
Workforce_Growth_Steepness = 0.7 #the higher it is, the more sudden the growth is
ZIPCODES = "^([0-9])"
