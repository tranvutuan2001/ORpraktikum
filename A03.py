...
WORKFORCE_Growth = 4  # Final value compared to Initial value
Workforce_Growth_Center = 20 # value from 0 to 1 to set the center of growth
Workforce_Growth_Steepness = 0.5 #the higher it is, the more sudden the growth is
ZIPCODES = "^([0-9])"
