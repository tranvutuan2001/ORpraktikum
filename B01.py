#Parameters
NUMBER_OF_YEARS = 5 # also the average lifespan of a heat pump
...
Max_Sales_Growth = 2 # Final value compared to Initial value
...
WORKFORCE_Growth = 1.33  # Final value compared to Initial value
