#Parameters
NUMBER_OF_YEARS = 10 # also the average lifespan of a heat pump
...
Max_Sales_Growth = 4 # Final value compared to Initial value
...
WORKFORCE_Growth = 1.66  # Final value compared to Initial value
